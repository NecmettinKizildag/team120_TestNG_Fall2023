...
public class C01_Priority {
    ...
    public void carpmaTesti() {
        ...
        // sayilarin carpmiminin 100 den buyuk oldugunu test edin
    ...
    public void cikarmaTesti(){
        // a ile b nin farkinin mutlak degferinin 100 den kucuk oldugunu test edin

        Assert.assertTrue((a-b)>-100 && (b-a)<100);
